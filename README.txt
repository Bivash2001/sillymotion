...
- Timeline UI to view, duplicate, or delete frames.
...
4. Adjust FPS with the slider to control playback speed.
5. (Optional) Add an audio file to animate in sync with sound.
6. Press "Play" to preview your animation with audio.
7. Press "Stop" to reset playback.
8. Use "Save Project" to store your work as a .json file.
9. Use "Load Project" to continue working later.
10. Export your animation as a WebM video when finished!
...
- Project saves store the *filename* of the audio, not the file itself. 
  (You’ll need to keep your audio file handy and reload it when continuing a project.)
- No GIF export (due to browser limitations).
- Works best with short to medium-length animations — very large projects may slow down your browser.
